...
public class ParqueaderoTest extends TestCase
{
    ...
    public void testCalcularPuestosLibres( )
    {
        ...
        assertEquals( "El parqueadero vacío no tiene el número correcto de puestos libres", Parqueadero.TAMANO, parqueadero1.calcularPuestosLibres( ) );

        assertEquals( "El parqueadero no-vacío no tiene el número correcto de puestos libres", Parqueadero.TAMANO - 2, parqueadero2.calcularPuestosLibres( ) );

        // Llenar el parqueadero
        for( int i = 3; i < Parqueadero.TAMANO; i++ )
        {
            parqueadero2.entrarCarro( "" + i + "" + i + "" + i );
            assertEquals( "El parqueadero no-vacío no tiene el número correcto de puestos libres", Parqueadero.TAMANO - i, parqueadero2.calcularPuestosLibres( ) );
        }
        ...
        for( int i = 0; i < 10; i++ )
        {
            ...
            assertEquals( "El parqueadero lleno no tiene el número correcto de puestos libres", 0, parqueadero2.calcularPuestosLibres( ) );
        }
    }
